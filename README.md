...
Introduction
------------
pmo is a MongoDB ORM that includes support for references,embed and even multilevel inheritance.
...
Database config file  (By default it locates at /vendor/Danz/Pmo/config.php)
...
\Danz\Pmo\MongoDB::setConfigBlock('default', array(
    'connection' => array(
        'hostnames' => 'localhost',
        'database'  => 'default',
        'options'  => array()
...
// 
\Danz\Pmo\MongoDB::setConfigBlock('auth', array(
    'connection' => array(
        'hostnames' => 'localhost',
        'database'  => 'authDB',
        'options'  => array()
...
2.Or you can duplicate a config file into your project, then define a global constanct 'PMO_CONFIG' with it's location.

```php

//in a global initialization place

define('PMO_CONFIG',__DIR__."/../config/pmo.php");

```

### Choose config section with APPLICATION_ENV

Which config section Pmo use ? Pmo choose 'default' section by default.
...
```php       
    ...
    class User extends Model 
    {
        ...
        protected static $attrs = array(
             ...
             // 1 to 1 reference
            'book_fav' => array('model'=>'Danz\Pmo\Test\Model\Book','type'=> Model::DATA_TYPE_REFERENCE),
             // 1 to many references
            'books' => array('model'=>'Danz\Pmo\Test\Model\Book','type'=> Model::DATA_TYPE_REFERENCES),
            ...
            'pet_fav' => array('model'=>'Danz\Pmo\Test\Model\Pet','type'=> Model::DATA_TYPE_EMBED),
            'pets' => array('model'=>'Danz\Pmo\Test\Model\Pet','type'=> Model::DATA_TYPE_EMBEDS),
...
```php
class Student extends \Danz\Pmo\Model
{
