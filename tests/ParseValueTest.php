...
class ParseValueTest extends \Danz\Pmo\Test\TestCase\PhactoryTestCase
{
  public $model;

  public function __construct()
  {
    $this->model = new \Danz\Pmo\Test\Model\DataType();
  }
  ...
  public function testArray()
  {
    ...
    $this->setExpectedException('\Danz\Pmo\Exception\InvalidDataTypeException');
    $data = 1;
    $actual = $this->model->parseValue('array', $data);
  }
...
//    $this->setExpectedException(\Danz\Pmo\Exception\InvalidDataTypeException::class);
//    $data = 'today';
//    $actual = $this->model->parseValue('timestamp', $data);
